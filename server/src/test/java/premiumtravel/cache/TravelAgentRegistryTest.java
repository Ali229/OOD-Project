...
//@AdditionalClasses( {TravelAgentRegistry.class} )
//public class TravelAgentRegistryTest {
//
//	private ArrayList<TravelAgent> travelAgents = new ArrayList<>();
//	private int initialSize;
//	@Inject @EJB private TravelAgentRegistry travelAgentRegistry;
//	@Inject @EJB private PersonFactory personFactory;
//
//	@BeforeEach
//	void setUp() {
